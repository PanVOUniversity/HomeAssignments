...
void saveGrayscaleBMP(const std::string& filename, const std::vector<uint8_t>& imageData, int width, int height) {
    ...
    uint8_t fileHeader[fileHeaderSize] = {
        ...
        0, 0, 0, 0,                 // Reserved
        fileHeaderSize + infoHeaderSize + colorTableSize, 0, 0, 0 // Offset to pixel data
    };
